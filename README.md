...
- **Язык:** Go  
- **Сервер:** net/http  
- **Хранилище:** PostgreSQL (можно изменить на Redis для высокой нагрузки) 
...
3. Настроить хранение состояния лимитов в **PostgreSQL** (можно Redis, но как для изучения пойдет PostgreSql)  
